...
module.exports = {
  extend: function(options) {
    ...
    if (ADDON_TREE_CACHING) {
      options[ADDON_TREE_CACHING] = function(treeType) {
    ...
    options.init = function() {
      ...
      this.treeForAddon = function(engineSourceTree) {
        ...
        if (needsRouteRemoval) {
          ...
          engineJSTree = new DependencyFunnel(engineJSTree, {
            exclude: true,
            entry: this.name+'/routes.js',
            external: ['ember-engines/routes']
          });
        ...
        return mergeTrees([externalTree, engineJSTree, engineCSSTree].filter(Boolean), { overwrite: true });
      };
      ...
      this.treeForPublic = function() {
        ...
        var engineAppTreeWithoutRoutes = new DependencyFunnel(engineJSTree, {
          exclude: true,
          entry: this.name+'/routes.js',
          external: ['ember-engines/routes']
        });
        ...
        if (engineCSSTree) {
          primaryStyleTree = concat(engineCSSTree, {
            allowNone: true,
            inputFiles: ['**/*.css'],
    ...
    */
    options.treeFor = function treeFor(name, source) {
      ...
      var cacheKey;
      if (ADDON_TREE_CACHING) {
        cacheKey = this[ADDON_TREE_CACHING](name);
