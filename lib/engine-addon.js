...
function buildEngineAppTree(engineSourceTree) {
  ...
  // Call the original treeForAddon function in case the consumer wants to
  // add something to it.
  engineSourceTree = this._originalTreeForAddon(engineSourceTree);
...
module.exports = {
  extend: function(options) {
    ...
    options.init = function() {
      ...
      this._originalTreeForAddon = this.treeForAddon;
      this.treeForAddon = function(engineSourceTree) {
        ...
        var engineTree = this._originalTreeForAddon.apply(this, arguments);
        var childAppTree = buildChildAppTree.call(this);
